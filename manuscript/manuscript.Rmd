...
We will focus on two of the most common such skill metrics, CRPS score and logs score [e.g. see @gneiting_strictly_2007; @gneiting_probabilistic_2014].
...
Overall forecasting skill scores are summarized in figure 2.
...
Forecasts of the Hopf bifurcation (Figure 2) are roughly comparable across the phenomenological models (ARIMA and machine learning models).
...
Those overestimates mean that the initial skill scores of the MCMC model are distinctly worse than those of any ML model during the early phase of the forecasts (Figures 6-7). 
This error shows up particularly in the CRPS scores (Figure 6), which have a higher penalty for over-estimating the spread than the negative log probabilities (Figure 7).
While the ML models fail to predict the core dynamical phenomenon of growing oscillations, 
