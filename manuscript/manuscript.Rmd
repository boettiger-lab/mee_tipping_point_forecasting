...
#|  time when the forecast predicts the wrong equilibrium state and the lower branch indicates predictions of the correct one. The time axis in this plot and in Figure 7 refers to the time from the beginning of the forecast window, not the time from the beginning of the time series as in other plots."
...
#|  The time axis in this plot and in Figure 6 refers to the time from the beginning of the forecast window, not the time from the beginning of the time series as in other plots."
