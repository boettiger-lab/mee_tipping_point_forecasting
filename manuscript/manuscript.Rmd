...
Neither is there one class of ML methods that outperforms the others -- a fact we found surprising given the reported dominance of encoder-decoders in the sequence-to-sequence deep learning subfield [@aitken_understanding_2021].
...
Furthermore, due to the black-box-ness of deep learning and other reasons like instability to initialization seed, it is often difficult to provide an explanation for why certain methods over-perform or fail to meet expectations.
