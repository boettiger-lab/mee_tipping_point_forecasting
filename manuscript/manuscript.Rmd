...
\begin{align}
H_{t+1} &= H_t \exp \left( r \left(1 - \tfrac{H}{K}\right) - c P_t + \eta_{H,t}
P_{t+1} &= H_t \exp \left( r \left(1  \tfrac{H}{K}\right) \right)  \left(1 -  \exp \left(- c P_t + \eta_{P,t}\right) \right)
\label{hopf}
\end{align}
...
Due both this sudden, catastrophic nature of the transition and the difficulty in reversing the shift after it has occurred, saddle-node bifurcations have become a nearly ubiquitous [@Scheffer2009]
