...
Uncertainty important to forecasting [@dietze_iterative_2018] and decision-making [@schindler_portfolio_2015]
...
Because uncertainty can play such an intrinsic role in ecological dynamics [@Boettiger2018; @hallett_why_2004; @Oveskienen], it is essential that machine learning applications to ecological forecasting are able to address probablistic forecasts adequately.
...
Robert May's consumer-resource model [@May1979], and the Nicholson-Bailey parasatoid-host model [@@nicholson_balance_1935]. 
...
These textbook models have been well studied and form the basis of half a century of research in ecology, including much recent work on topics such as resilience and tipping points [] which has had important theoretical and practical management outcomes [@folke_principles_2009].
...
Tipping point dynamics have long been identified as an important but difficult challenge for forecasting [e.g. @scheffer_catastrophic_2001]. 
...
Tipping points resulting from Saddle-node bifurcations have been demonstrated in examples ranging from laboratory microcosms [@Dei2011; @Dei2012] to whole-ecosystem experiments [@carpenter_early_2011], and postulated as a model for global change [@hadly_end_2015]. 
