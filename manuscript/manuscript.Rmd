...
We have defined these two scores explicitly in Equations 7-8, where $F$ and $f$ are the respective CDF's and PDF's from a probabilistic forecast, and $y$ refers to an observation.
...
This paper is not intended to give a complete answer to whether deep learning is the best suited method for tipping point forecasting problems as this will take numerous studies to resolve; instead, this paper aims to be an early exploration on whether deep learning methods should be considered as viable tools for this extremely challenging class of prediction problems. <!-- I think here would perhaps be a good place to flesh out "promising" tag, stuck on how to do so-->
Since we have shown that ML models can make relatively good forecasts on our selected tipping point scenarios, particularly the stochastic transition case, we have established that these deep learning models are worthy of further investigation regarding their application to critical transition forecasting problems.
