...
Using model-based simulations allows us to examine performance against a multiple (n=100) replicates of the "true" process, which further helps identify differences that may occur solely due to chance. 
