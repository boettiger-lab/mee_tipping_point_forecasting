...
Thus our examples of scoring and visualization will rely on a collection of R packages, in particular, `scoringRules` for the efficient calculation of Continuous Ranked Probability Score (CRPS) and logarithmic probability scores for forecast ensembles [@gneiting_strictly_2007].
...
Tipping point dynamics have long been identified as an important but difficult challenge for forecasting [e.g. @scheffer_catastrophic_2001; @Folke2004]. 
...
Tipping points resulting from Saddle-node bifurcations have been demonstrated in examples ranging from laboratory microcosms [@Dai2013; @Dai2015] to whole-ecosystem experiments [@carpenter_early_2011], and postulated as a model for global change [@Barnosky2012]. 
...
shift |> 
  ...
  #geom_boxplot(col="black", outlier.size=0, outlier.shape = ".", outlier.alpha=0) +
