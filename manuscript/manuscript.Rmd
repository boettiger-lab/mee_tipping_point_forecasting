...
When machine learning models are able to observe transition phenomena, as in the stochastic case, they generally outperformed MCMC-based forecasting with respect to CRPS and log probability score but under-performed MCMC when there were no transition events in the training sets as in the Hopf and Saddle-node examples.
Yet, there are many nuances to these assessments as examining summary statistics, CRPS and log probability scores obscure finer detailed components of the forecasts, like the pronounced bimodality of ML forecasts for the stochastic transition case. 
