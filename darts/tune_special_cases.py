...
parser.add_argument(
    ...
    default="both",
    type=str,
    help="Special cases to consider (tipped, non_tipped, both)",
)
parser.add_argument(
    "--seed",
    default=42,
...
if args.case.lower() == "tipped":
    train_series = TimeSeries.from_csv("tipped.csv", time_col="time")
elif args.case.lower() == "non_tipped":
    train_series = TimeSeries.from_csv("non_tipped.csv", time_col="time")
elif args.case.lower() == "both":
    train_series = TimeSeries.from_csv("tipped.csv", time_col="time")
    train_series_ = TimeSeries.from_csv("non_tipped.csv", time_col="time")
